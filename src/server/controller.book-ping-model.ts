...
import { BookPingModelResponse, bookPingModelService, BookPingModelPathParams } from "../shared/service.book-ping-model.js";
import { AbstractController } from "./main.controller.js";
import { submitBookPrompt } from "./util.submit-prompt.js";
import { getBook } from "./util.book.js";

export class BookPingModelController extends AbstractController<NoBodyParams, BookPingModelPathParams, BookPingModelResponse> {
