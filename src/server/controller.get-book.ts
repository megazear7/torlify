...
export class GetBookController extends AbstractController<NoBodyParams, GetBookPathParameters, Book> {
  async handler({ pathParams }: RequestOptions<NoBodyParams, GetBookPathParameters>): Promise<Book> {
