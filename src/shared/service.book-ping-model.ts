...
export class BookPingModelService extends AbstractService<NoBodyParams, BookPingModelPathParams, BookPingModelResponse> {
  readonly type = ServiceType.enum.json;
  readonly method = HttpMethod.enum.get;
  readonly path = "/api/book/:book/model/ping";
}

export const bookPingModelService = new BookPingModelService(NoBodyParams, BookPingModelPathParams, BookPingModelResponse);